@extends('admin.layouts.default',['title' => 'LOT'])

@section('content')
      <div class="app-title">
        <div>
          <h1 style="font-size: 16px;"><i class="fa fa-dashboard"></i> LISTE DES LOTISSEMENTS : {{$lot->count()}}</h1>
        </div>
      ...
      <div class="row">
    <div class="col-12">
      <a href="/managment/ajouter/lot" class="btn btn-info ajouter_equipe"> <i class="fa fa-edit"></i> Ajouter un lotissement</a><br><br>
    </div>

        <div class="col-md-12">
          <div class="tile">
            <div class="tile-title-w-btn">
              <h3 class="title">Tous les lotissements</h3></div>
            <div class="tile-body">
                        ...
                        <tr>
                          ...
                          <td valign="center">
                            <div align="center" class="tools">
                              <a href="/managment/update/lot/{{$ac->id}}" class="btn bg-green btn-flat voir_docoment" style="width: 10px;">
                                <i class="fa fa-eye"></i>
                              </a> 
                              
                              <a href="/managment/delete/lot/{{$ac->id}}" class="btn bg-orange btn-flat delete_equipe" style="width: 10px;">
...
<script type="text/javascript">
      ...
      $(document).on("click",".delete_equipe", function(e){
        ...
        swal({
          title: "SUPPRESSION",
          text: "Etre Vous sûre de vouloir supprimer ce lot ?",
          type: "warning",
          ...
          if (isConfirm) {
            swal("Sppression!", "Lot supprimé avec succès .", "success");
