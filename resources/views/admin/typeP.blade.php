@extends('admin.layouts.default',['title' => 'MODELES DE MAISON'])

@section('content')
      <div class="app-title">
        <div>
          <h1 style="font-size: 16px;"><i class="fa fa-dashboard"></i> LISTE DES MODELES DE MAISON : {{$type->count()}}</h1>
        </div>
      ...
      <div class="row">
    <div class="col-12">
      <a href="/managment/ajouter/projet" class="btn btn-info ajouter_equipe"> <i class="fa fa-edit"></i> Ajouter un modele</a><br><br>
    </div>

        <div class="col-md-12">
          <div class="tile">
            <div class="tile-title-w-btn">
              <h3 class="title">Tous les modèles de maison</h3></div>
            <div class="tile-body">
                        ...
                        @endif
                          ...
                          <td valign="center">
                            <div align="center" class="tools">
                              <a href="/managment/update/typePr/{{$ac->id}}" class="btn bg-green btn-flat voir_docoment" style="width: 10px;">
                                <i class="fa fa-eye"></i>
                              </a> 
                              
                              <a href="/managment/delete/delete_typePr/{{$ac->id}}" class="btn bg-orange btn-flat delete_equipe" style="width: 10px;">
