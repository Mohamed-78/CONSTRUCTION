@extends('admin.layouts.default',['title' => 'CONSTRUCTIONS'])

@section('content')
      <div class="app-title">
        <div>
          <h1 style="font-size: 16px;"><i class="fa fa-dashboard"></i> LISTE DES CONSTRUCTIONS : {{$construction->count()}}</h1>
        </div>
        ...
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-title-w-btn">
              <h3 class="title">Toutes les constructions</h3></div>
            <div class="tile-body">
                        ...
                        <tr>
                          ...
                          <td valign="center">
                            <div align="center" class="tools">
                              <a href="/managment/update/const/{{$ac->id}}" class="btn bg-green btn-flat voir_docoment" style="width: 10px;">
                                <i class="fa fa-eye"></i>
                              </a> 
                              
                              <a href="/managment/delete/const/{{$ac->id}}" class="btn bg-orange btn-flat delete_equipe" style="width: 10px;">
