@extends('admin.layouts.default',['title' => 'TEMOIGNAGES'])

@section('content')
      <div class="app-title">
        <div>
          <h1 style="font-size: 16px;"><i class="fa fa-dashboard"></i> LISTE DES TEMOIGNAGES: {{$temoignage->count()}}</h1>
        </div>
      ...
      <div class="row">
    <div class="col-12">
      <a href="/managment/ajouter/temoignage" class="btn btn-info ajouter_equipe"> <i class="fa fa-edit"></i> Ajouter un temoignage</a><br><br>
    </div>

        <div class="col-md-12">
          <div class="tile">
            <div class="tile-title-w-btn">
              <h3 class="title">Toutes les temoignages</h3></div>
            <div class="tile-body">
              ...
              @if($temoignage)
               <table class="table table-hover table-bordered" id="sampleTable">
                    ...
                    <tbody>
                      @foreach($temoignage as $ac)
                        <tr>
                          <td><img src="{{URL::asset('admin/media/'.$ac->photo)}}" alt="" style="max-height: 50px; max-width: 50px;"></td>
                          <td>{{$ac->nom}}</td>
                          <td>{{substr($ac->msg,0,45)}}{{ (strlen($ac->description) >= 45) ? '...' : '' }}</td>
                          <td valign="center">
                            <div align="center" class="tools">
                              <a href="/managment/update/temoin/{{$ac->id}}" class="btn bg-green btn-flat voir_docoment" style="width: 10px;">
                                <i class="fa fa-eye"></i>
                              </a> 
                              
                              <a href="/managment/delete/temoin/{{$ac->id}}" class="btn bg-orange btn-flat delete_equipe" style="width: 10px;">
...
<script type="text/javascript">
      ...
      $(document).on("click",".delete_equipe", function(e){
        ...
        swal({
          title: "SUPPRESSION",
          text: "Etre Vous sûre de vouloir supprimer cette construction ?",
          type: "warning",
          ...
          if (isConfirm) {
            swal("Sppression!", "Construction supprimée avec succès .", "success");
