  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/managment/updated/terrain/{{ $single->id }}" method="post" enctype="multipart/form-data">
          @csrf
          <div class="row">
            ...
            <div class="form-group col-sm-6">
               <label class="control-label">Dimension</label>
                <input type="text" class="form-control" name="dimension" value="{{ $single->dimension }}" required="">
            </div>
            <div class="form-group col-sm-6">
              <label> Image principale (taille: 368*235)</label>
